...
const createRouter = (io) => {
    ...
    router.get('/orders/:id', ordersController.getParticularOrder);
    router.get('/filterOrderByFilter', ordersController.fetchDataByFilters);
    router.post('/orders/:id/cancel', (req, res) => ordersController.cancelOrder(req, res, io));
    router.post('/createOrder', ordersController.createOrder);
    router.post('/updateOrder', (req, res) => ordersController.updateOrder(req, res, io));
    router.post('/updateTrade', ordersController.updateTrade);
    router.get('/ordersStatus', authenticateToken, ordersController.fetchDatathroughStatus);

    // Routes for the Disputes section
    router.post('/orders/:id/disputes', (req, res) => disputesController.createDispute(req, res, io));
